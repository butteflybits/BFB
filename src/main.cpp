...
uint256 hashGenesisBlock("0x000003478d409690f0e71eb81529568315f5fc9d1ebaaad2cf4bdcfaf775ab0d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // ButterflyBits: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ButterflyBits Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 100000000 * COIN; // Premine 100,000,000 BFB
	}
...
static const int64 nTargetTimespan = 2.5 * 60;	// ButterflyBits: 2.5 mins 
static const int64 nTargetSpacing = 60;			// ButterflyBits: 30 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal butterflybits miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ButterflyBits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000003478d409690f0e71eb81529568315f5fc9d1ebaaad2cf4bdcfaf775ab0d");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "In May 15, 2015, Asteroid 1999 FN53 passes by Earth today. 1431659527.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1431659527;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2637702;
        ...
        assert(block.hashMerkleRoot == uint256("0x1e7c1e82e0a993ee5eeb1d0b8334382db2f4ec10f7d87972882425beef0d3ee9"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // butterflybitsd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
